...
const sections = {
  terms: {
    ...
    intro: 'WriteHabit은 매일 하나의 키워드로 글을 쓰고 읽는 서비스입니다. 현재는 베타 운영 중이며, 기능과 정책은 안정화 과정에서 변경될 수 있습니다.',
    items: [
      ...
      ['문의', `계정, 콘텐츠, 신고, 약관 관련 문의는 ${CONTACT_EMAIL}로 보내주세요. 베타 기간에는 같은 주소로 오류 제보와 사용 피드백도 받습니다.`],
    ],
  },
  privacy: {
    ...
    items: [
      ['수집 항목', '이메일, 닉네임, 비밀번호 해시, 프로필 정보, 작성 글, 임시저장 글, 좋아요, 북마크, 팔로우, 차단, 신고 정보, 알림 정보가 저장될 수 있습니다.'],
      ['이용 목적', '회원 식별, 로그인, 글 작성과 공개, 프로필 표시, 알림 제공, 신고 처리, 서비스 안정성 개선을 위해 사용합니다.'],
